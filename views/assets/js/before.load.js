...
$(document).ready(function($) {
    ...
    if( $body.hasClass('navigation-top-header') ) {
        $( ".main-navigation.navigation-top-header" ).load( "views/views/assets/external/_navigation.html" );
		navigationStyle = "topHeader";
    }
    else if( $body.hasClass('navigation-off-canvas') ) {
        $( ".main-navigation.navigation-off-canvas" ).load( "views/assets/external/_navigation.html" );
...
function mobileNavigation(){
    if( $(window).width() < 979 ){
		...
		if( navigationStyle == "topHeader" ){			
			$( ".main-navigation.navigation-top-header" ).load( "views/assets/external/_navigation.html" );
